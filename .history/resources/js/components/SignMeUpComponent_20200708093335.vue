<template>
        <div class="root">
            <div class="pattern">
                <!-- <img src="http://127.0.0.1:8000/images/spattern.png" alt=""> -->
            </div>
            <div class="container">
                <div class="logo">
                    <a href="/"><img src="http://127.0.0.1:8000/images/logo.png" alt="Mindanao Art Logo"></a>
                </div>
                <div class="form">
                    <h1>Register</h1>
...
<style lang="scss" scoped>
    ...
    .pattern {
        width: 100%;
        background: url(http://127.0.0.1:8000/images/spattern.png);
