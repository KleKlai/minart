<template>
    <div>
        ...
        <div class="container">
            ...
            <div class="time">
                <h3>Living Art in New Landscape</h3>
                <countdown :time="time" :interval="100" tag="p">
                    <template slot-scope="props">
                        <div class="root">
                            <h1 class="day">{{ props.days }}</h1> <p class="column1">:</p>
                            <h1 class="hour">{{ props.hours }}</h1> <p  class="column2">:</p>
                            <h1 class="minute">{{ props.minutes }}</h1> <p class="column3">:</p>
                            <h1 class="seconds">{{ props.seconds }}</h1>
                        </div>
                    </template>
                </countdown>
            </div>
            <div class="signup">
                <a class="link" href="/signmeup">SIGN ME UP > > ></a>
...
<style>
    ...
    .picture { grid-area: picture; justify-items: end;}
    ...
    .root {
        ...
        grid-template-areas: 
            ...
            "dayl space hourl space minutel space secondl";
    }
